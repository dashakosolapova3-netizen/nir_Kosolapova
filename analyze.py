...
class RegistrationFormAnalyzer:
    ...
    def load_all_sessions(self):
        ...
        if not os.path.exists(self.data_folder):
            print(f"Папка {self.data_folder} не найдена.")
    ...
    def classify_session(self, session):
        ...
        Четный ID - Modal, Нечетный ID - Inline.
        """
        # --- Метод 1: По номеру участника ---
    ...
    def calculate_gaze_metrics(self, gaze_data):
        ...
        # Фильтр выбросов, если слишком быстрые скачки, значит есть потеря трекинга
    ...
    def analyze_session(self, session):
        ...
        # Фильтруем задания по формам регистрации
